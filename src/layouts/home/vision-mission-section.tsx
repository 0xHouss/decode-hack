...
export default function VisionMission() {
  return (
    <Section id="vision-mission" className="flex flex-col gap-10 items-center max-w-6xl">
      <h2 className="text-4xl md:text-5xl bg-gradient-to-r text-center lg:text-left from-[#E9FDB0] to-[#4E941A] bg-clip-text text-transparent">Our Vision & <br className="md:hidden" /> Mission</h2>
